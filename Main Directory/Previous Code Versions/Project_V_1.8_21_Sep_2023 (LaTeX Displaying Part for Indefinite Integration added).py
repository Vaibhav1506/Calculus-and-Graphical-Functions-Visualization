...
def convert_to_Latex_and_display(x):
    ...
    if "e" in x:
        ...
        exp = expression_list[0][2:-1]
        for key, value in mappings.items():
            exp = exp.replace(key, value)
        num_r = "(e^{" + exp + "})"
        den_r = expression_list[1]
        final_exp = "\dfrac" + "{" + num_r + "}" + "{" + den_r + "}" + x[-4:]  
        st =  '$' + final_exp + '$'
...
# Indefinite integration
    ...
    if ch2 == 1:  # trigonometric
        ...
        if ch3 == 1:
            ...
            I = f"(-log(|cos({exp})|)/{a}) + k"  # /u00bx is used for superscripting of x
        elif ch3 == 4:
            I = f"(log(|sin({exp})|)/{a}) + k"  # /u00bx is used for superscripting of x
        elif ch3 == 5:
            I = f"(-log(|csc({exp}) + cot({exp})|)/{a}) + k"
        elif ch3 == 6:
        ...
        if ch3 == 1:
            ...
            I = f"(tan{inv}(({exp})/√({b}))/({a}√({b}))) + k" 
        elif ch3 == 4:
            I = f"(cot{inv}(({exp})/√({b}))/({a}√({b}))) + k"
        elif ch3 == 5:
            I = f"(sec{inv}({exp})/{a}) + k"
        elif ch3 == 6:
            I = f"(csc{inv}({exp})/a) + k"
        ...
        a = int(input("Enter value of a: "))
        c = int(input("Enter value of c: "))
        I = f"{int(a/2) if a % 2 == 0 else (a/2)}x{get_sup('2')} + {c}x + k"
        ...
        if ch3 == 1:
            ...
            I = f"({a}{get_sup('x')}/log({a})) + k"

    elif ch2 == 5:  # exponential of form e^(ax+c)
        a = int(input("Enter value of a: "))
        c = int(input("Enter value of c: "))
        exp = f"{a}x + {c}" 
        I = '((e' + f'{get_sup(exp)}' + f")/{a}) + k"
...
convert_to_Latex_and_display(I)