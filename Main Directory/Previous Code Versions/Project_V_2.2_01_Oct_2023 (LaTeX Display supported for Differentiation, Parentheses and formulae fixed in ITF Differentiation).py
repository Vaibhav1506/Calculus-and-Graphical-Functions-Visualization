...
def convert_to_Latex_for_differentials(x):
    ...
    if "√" in x and "/" in x:
        ...
        for item in expression_list:
            ...
            updated_expression_list.append(updated_item)  # Append the updated item to the list

        st = "$\dfrac{" + updated_expression_list[0] + "}{" + updated_expression_list[1] + "}$"

    elif "/" in x:
        expression_list = x.split("/")  # Split the expression correctly
        st = "$" + '\dfrac{' + expression_list[0] + "}{" + expression_list[1] + "}" + "$"
...
def convert_to_Latex_for_integrals(x):
    mappings = {                             #mappings corresponding to the LATEX notation for diff. mathematical notations.
            "cos": r"\cos",                  #Converts a mathematical expression to LaTeX format.
            "sin": r"\sin",
            "tan": r"\tan",
...
if ch1 == 2 or ch1 == 3:
    ...
    if type(I) == int or type(I) == float:
        ...
        RHS = convert_to_Latex_for_integrals(I)[1:]
    ...
    RHS = convert_to_Latex_for_differentials(I)[1:]
    final_exp = "$" + LHS + " " + RHS
