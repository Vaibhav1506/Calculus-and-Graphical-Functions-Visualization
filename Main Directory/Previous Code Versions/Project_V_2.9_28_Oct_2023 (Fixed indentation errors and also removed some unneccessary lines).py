...
import datetime  # Used for tracking the time.
...
def get_date_time():  # Function to track time
    ...
    return [f"{day}-{month}-{year}", f"{hour}:{minute}:{second}"]  # Storing in a list
...
DT = []  # to store date and time

# MAIN CODE
print("-" * 50)
print("This is the Calculus & Function Visualizations in Python")
print("-" * 50)
...
while n.upper() == "Y":
    ans_history = [["Operation Type", "Function Type", "Function", "Answer", "Date", "Time"]]  # Initializing a list
    ...
    while True:  # Running a loop
        ...
        try:
            ...
            if ch1 == 1:
                ...
                DT = get_date_time()  # get date and time.
            ...
            if ch1 in range(1, 6):
                ...
                if I != "":
                    ...
                    print("Answer:", I)
                    if ch1 == 1:
                        ans_history.append(["Differentiation", func_type, func, I, DT[0], DT[1]])

                    elif ch1 == 2:
                        ans_history.append(["Indefinite Integration", func_type, func, I, DT[0], DT[1]])

                    elif ch1 == 3:
                        ans_history.append(["Definite Integration", func_type, func, I, DT[0], DT[1]])

                    elif ch1 == 4:
                        ans_history.append(["Graph", func_type, I, "-", DT[0], DT[1]])
