...
print("-" * 80)
print("")
print("You can view more information about this project (including VERSION HISTORY , CHANGELOGS and DOCUMENTATION) on this Github Repository :- https://github.com/Vaibhav1506/Calculus-Functions-Visualization-Python-MySql-Connectivity.")
print("")
