...
def graph_function_for_polynomials(coefficients,final_exp):
    ...
    x = np.linspace(min_root - 1, max_root + 1, 1000)    # Generate  1000 x-values' intervals for plotting based on the roots
...
print("IMPORTANT NOTES TO BE TAKEN BEFORE PROCEEDING")         #Made it user friendly and rules to avoid errors.
...
while n == 'Y' or n == "y":        
    ...
    while True:
        ...
        print("MAIN MENU:\n1.Differentiation\n2.Indefinite Integration\n3.Definite Integration\n4.Graphs\n5.Exit\n6.User Input History")  #Main menu for selecting operation type    
        ...
        try:
            ...
            if ch1 == 1: 
                ...
                if ch2 == 1:  # Trigonometric
                    ...
                    for i in expression_list_2:
                        i = i.replace("ax+c", exp)
                        new_expressions_list_2.append(i)
            ...
            # Indefinite integration
                ...
                if ch2 == 1:  # trigonometric
                    ...
                    for k in expression_list_2:
                        k = k.replace("ax + c", exp)
                        new_expressions_list_2.append(k)

                    for l in new_expressions_list_2:
                        l = l.replace("b", f"{b}")
                        final_expressions_list_2.append(l)
                ...
                func_type = choice_type[ch2 - 1]                                             #with respect to with the function should be integrated. For e.g.: ∫f(x)dx is the 
            ...
            elif ch1 == 6: #Shows answer history
                if ans_history == []:
                    print("No answer history to show.")
                else:
                    print("Displaying answer history: ")
                    for i in ans_history:
                        print(i)
            ...
            if ch1 in range(1, 6):
                ...
                if I != "":
                    ...
                    print("Answer:" , I)
                    if ch1 == 1:
                        ans_history.append(["Differentiation", func_type, func , I])
                    elif ch1 == 2:
                        ans_history.append(["Indefinite Integration",func_type , func, I])
                    elif ch1 == 3:
                        ans_history.append(["Definite Integration", func_type ,func, I])
                    elif ch1 == 4:
                        ans_history.append(["Graph", func_type ,"None" , I])
